...
class FilterAdapter(
    ...
    RecyclerView.Adapter<FilterAdapter.ProductsAdapterViewHolder>() {
        ...
        holder.itemView.apply {
            ...
            if (filter.isSelected) {
                ...
                cont_filter.background =
                    ResourcesCompat.getDrawable(
                        context.resources,
                        R.drawable.stroke_grey_5_radius,
                        null
                    )
    ...
    interface OnFiltersClickListener {
        fun onFilterItemClick(position: Int, getSportsSport: GetSportsSport)
    }
}