...
class VenuePlayFacilitiesAdapter(
    private val c: Context,
    private val amenities: ArrayList<PlayFeature>
) : RecyclerView.Adapter<VenuePlayFacilitiesAdapter.VenueFacilitiesAdapterViewHolder>() {
