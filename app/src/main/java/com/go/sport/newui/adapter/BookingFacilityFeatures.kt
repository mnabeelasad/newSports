...
class BookingFacilityFeatures (
    private val c: Context,
    private val facilities: ArrayList<GetFeaturesData>
) : RecyclerView.Adapter<BookingFacilityFeatures.BookingFacilityFeaturesViewHolder>() {
    class BookingFacilityFeaturesViewHolder(view: View) : RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BookingFacilityFeaturesViewHolder {
        return BookingFacilityFeaturesViewHolder(
    ...
    override fun onBindViewHolder(holder: BookingFacilityFeaturesViewHolder, position: Int) {
